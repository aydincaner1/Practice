...
public class Application {
	...
	public static void main(String[] args) {
			...
			Courses courses1=new Courses
					("\\image\\coursesImage1.jpg", "Java Kampı", "Engin Demiroğ", 0);
			
			Courses courses2=new Courses
					("\\image\\coursesImage1.jpg", "C# Kampı", "Engin Demiroğ", 0);
			
			Courses courses3=new Courses
					("\\image\\coursesImage1.jpg", "Flutter Kampı", "Engin Demiroğ", 0);
			...
			for (Courses courses : coursesArray) {
				System.out.print("Açılan kurs adı:" +courses.name);
			}
			System.out.print("\n");
